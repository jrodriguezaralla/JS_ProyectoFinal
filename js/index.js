    ...
    if(carrito.length >= 1){
        ...
        dato.forEach((elemento)=>{
            ...
            div.innerHTML = `
                            ...
                            <button id="eliminar${elemento.id}" type="button" class="position-absolute top-0 end-0 btn btn-outline-danger btn-sm me-1 mt-1 btnEliminarProd d-flex justify-content-center align-items-center">
